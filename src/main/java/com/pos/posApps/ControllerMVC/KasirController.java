...
public class KasirController {
    ...
    @GetMapping
    public String displayKasir(Model model, HttpSession session, Long transactionId, @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "20") Integer size) {
        Long clientId;
        try {
