...
@Component
public class LaporanPengeluaranPeriodePdfExporter {
    ...
    public void export(
            List<LaporanPembelianPerWaktuDTO> rows,
            LocalDate startDate,
            LocalDate endDate,
        ...
        try {
            ...
            Paragraph title = new Paragraph("Laporan Pembelian Per Periode", titleFont);
            ...
            int index = 1;
            for (LaporanPembelianPerWaktuDTO row : rows) {
