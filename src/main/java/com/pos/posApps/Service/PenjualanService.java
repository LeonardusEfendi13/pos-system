...
public class PenjualanService {
    ...
    public List<PenjualanDTO> getPenjualanData(String clientId, LocalDateTime startDate, LocalDateTime endDate) {
        List<TransactionEntity> transactionData = transactionRepository.findAllByClientEntity_ClientIdAndTransactionDetailEntitiesIsNotNullAndDeletedAtIsNullAndCreatedAtBetweenOrderByCreatedAtDesc(clientId, startDate, endDate);
    ...
    public PenjualanDTO getPenjualanDataById(String clientId, String penjualanId) {
    ...
    @Transactional
    public boolean deletePenjualan(String transactionId, String clientId){
        ...
        List<TransactionDetailEntity> transactionDetailEntities = transactionDetailRepository.findAllByTransactionEntity_TransactionIdOrderByCreatedAtDesc(transactionId);
